; song_demo.asm — demo song data for the hUGEDriver playback test.
;
; hUGEDriver's bundled example tune (rgbds_example/sample_song.asm, public
; domain), taken from the SAME hUGETracker 1.0.11 distribution as the driver so
; the descriptor format matches (see PROVENANCE.md). Only the song-descriptor
; label was renamed (sample_song -> song_demo) so game code refers to it clearly.
; To swap in your own music, export a song from hUGETracker in "RGBDS .asm"
; format and replace this file, keeping the `song_demo::` label.

...
def _run(poison):
    ...
    try:
        ...
        # slots 10..19 are the survivor NPCs, 20 the splash, 21 the parked car
        # (all legitimate — see test_sprites.py); 22+ must stay hidden.
        garbage = [s for s in range(22, 40) if g.sprite(s)["y"] != 0]
